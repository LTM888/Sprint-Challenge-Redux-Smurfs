...
Actions are small departments which store packets of information that contain an action type and some data, the reducers are the place where you can update state and the store contains the state of the application.
...
Redux-thunk is a  middleware used to handle asynchronous actions in Redux.Redux-Thunk package to extend your actions so that you have the ability to consume promises.
